...
def compute_aurc(coverages, risks):
    # Standard AURC: trapezoid over coverage directly (no rescale).
...
summary = {
    ...
    "deterministic_exp03": {
        ...
        "auroc_ed": det_auroc,
        # ponytail: literals pending P2 pixel-level recompute (no probs locally).
        "esce": 0.0012,
        "esce_provenance": "placeholder_literal_pending_pixel_recompute",
        "brier": 0.0001,
        "brier_provenance": "placeholder_literal_pending_pixel_recompute",
        "aurc": aurc_det
    },
    "mc_dropout_exp04": {
...
# Figure 3: Error Detection ROC curve — SKIPPED: no empirical pixel-level
# ROC data available locally (previous synthetic power-curve removed as
# misleading). Regenerated by P2 Kaggle job with global pixel-pooled roc_curve.
print("Skipped fig3 (needs empirical ROC from pixel-level job)")
